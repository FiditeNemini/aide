...
import './media/aideAgentEditorController.css';
...
import { ChatEditingSessionState, IAideAgentEditingService, IModifiedFileEntry, WorkingSetEntryState } from '../common/aideAgentEditingService.js';
...
import { isDiffEditorForEntry } from './aideAgentEditing/aideAgentEditing.js';
...
export const ctxIsGlobalEditingSession = new RawContextKey<boolean>('aideAgent.isGlobalEditingSession', undefined, localize('chat.ctxEditSessionIsGlobal', "The current editor is part of the global edit session"));
export const ctxHasEditorModification = new RawContextKey<boolean>('aideAgent.hasEditorModifications', undefined, localize('chat.hasEditorModifications', "The current editor contains chat modifications"));
export const ctxHasRequestInProgress = new RawContextKey<boolean>('aideAgent.ctxHasRequestInProgress', false, localize('chat.ctxHasRequestInProgress', "The current editor shows a file from an edit session which is still in progress"));
export const ctxReviewModeEnabled = new RawContextKey<boolean>('aideAgent.ctxReviewModeEnabled', true, localize('chat.ctxReviewModeEnabled', "Review mode for chat changes is enabled"));
...
export class ChatEditorController extends Disposable implements IEditorContribution {
	...
	constructor(
		...
		@IAideAgentEditingService private readonly _chatEditingService: IAideAgentEditingService,
		@IInstantiationService private readonly _instantiationService: IInstantiationService,
		@IAideAgentAgentService private readonly _chatAgentService: IAideAgentAgentService,
		@IEditorService private readonly _editorService: IEditorService,
		@IContextKeyService contextKeyService: IContextKeyService,
		@IAideAgentService chatService: IAideAgentService,
	) {
		super();
