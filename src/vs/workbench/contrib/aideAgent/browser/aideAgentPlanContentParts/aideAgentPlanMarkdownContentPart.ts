...
import { codeblockHasClosingBackticks, EditorPool } from '../aideAgentContentParts/aideAgentMarkdownContentPart.js';
	...
	constructor(
		...
		const result = this._register(renderer.render(markdown.content, {
			...
			codeBlockRendererSync: (languageId, text, raw) => {
				...
				const isCodeBlockComplete = context.element.isComplete || !raw || codeblockHasClosingBackticks(raw);
				...
				const codeBlockInfo: ICodeBlockData = { languageId, textModel, codeBlockIndex: globalIndex, codeBlockPartIndex: thisPartIndex, element, range, parentContextKeyService: contextKeyService, vulns, codemapperUri };
