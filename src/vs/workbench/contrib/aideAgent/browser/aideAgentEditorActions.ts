...
import { ChatEditorController, ctxHasEditorModification, ctxReviewModeEnabled } from './aideAgentEditorController.js';
...
abstract class NavigateAction extends Action2 {
	...
	constructor(readonly next: boolean) {
		super({
			id: next
				? 'aideAgentEditor.action.navigateNext'
				: 'aideAgentEditor.action.navigatePrevious',
			title: next
				? localize2('next', 'Go to Next Edit')
				: localize2('prev', 'Go to Previous Edit'),
...
export class AcceptAction extends AcceptDiscardAction {
	...
	static readonly ID = 'aideAgentEditor.action.accept';
...
export class RejectAction extends AcceptDiscardAction {
	...
	static readonly ID = 'aideAgentEditor.action.reject';
...
class RejectHunkAction extends EditorAction2 {
	constructor() {
		super({
			id: 'aideAgentEditor.action.undoHunk',
			title: localize2('undo', 'Discard this Change'),
			category: CHAT_CATEGORY,
			precondition: ContextKeyExpr.and(ctxHasEditorModification, CONTEXT_CHAT_REQUEST_IN_PROGRESS.negate(), hasUndecidedChatEditingResourceContextKey),
...
class AcceptHunkAction extends EditorAction2 {
	constructor() {
		super({
			id: 'aideAgentEditor.action.acceptHunk',
...
class OpenDiffAction extends EditorAction2 {
	constructor() {
		super({
			id: 'aideAgentEditor.action.diffHunk',
...
export const navigationBearingFakeActionId = 'aideAgentEditor.navigation.bearings';
